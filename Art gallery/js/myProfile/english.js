$(document).ready(function(){
    ...
    $("#potvrdi").click(function(){
        ...
        $("#korime").val("");
        if(korime==""){
            $("#porukaGreske").html("You must enter your username in order to log in!");
            return;
        }
    ...
    function init(){
        ...
        komentari.forEach(komentar => {
            if(komentar.korisnik == localStorage.getItem("korisnik")){
                ...
                h4Element.textContent = "Artwork: " + komentar.delo;
        ...
        ponude.forEach(ponuda => {
            if(ponuda.korisnik == localStorage.getItem("korisnik")) {
                ...
                var h4Element = document.createElement('h4');
                h4Element.textContent = "Artwork: " + ponuda.delo;
